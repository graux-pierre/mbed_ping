...
void arp_request(uint8_t* buffer, uint8_t dest_mac_addr[6], uint8_t dest_ip_addr[4], uint8_t source_mac_addr[6], uint8_t source_ip_addr[4]){
  ...
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[0] = source_mac_addr[0];
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[1] = source_mac_addr[1];
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[2] = source_mac_addr[2];
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[3] = source_mac_addr[3];
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[4] = source_mac_addr[4];
  ((ARP_HEADER*)(buffer+14))->sender_hardware_addr[5] = source_mac_addr[5];
  
  ((ARP_HEADER*)(buffer+14))->sender_logical_addr[0] = source_ip_addr[0];
  ((ARP_HEADER*)(buffer+14))->sender_logical_addr[1] = source_ip_addr[1];
  ((ARP_HEADER*)(buffer+14))->sender_logical_addr[2] = source_ip_addr[2];
  ((ARP_HEADER*)(buffer+14))->sender_logical_addr[3] = source_ip_addr[3];
  
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[0] = dest_mac_addr[0];
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[1] = dest_mac_addr[1];
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[2] = dest_mac_addr[2];
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[3] = dest_mac_addr[3];
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[4] = dest_mac_addr[4];
  ((ARP_HEADER*)(buffer+14))->target_hardware_addr[5] = dest_mac_addr[5];
